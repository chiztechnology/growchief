        ...
        <div className="flex justify-between items-center p-4 flex-col md:flex-row m-12">
            <div className="flex flex-col items-center md:items-start">
                <Image
                    ...
                    alt="Growchief logo"
                />
                <p className="text-slate-400 font-sans text-light mt-6 w-[478px] md:w-[329px] text-center md:text-left">We do a whole week of launch around your prouct, including an article, Reddit promotion, influencers posts, and so much more</p>
            </div>
            ...
            <div className="mt-4 md:mt-0">
                ...
                <div className="flex flex-col md:flex-row mt-4">
                    ...
                    <div className="customButton mt-4 md:mt-0 md:ml-4 bg-gradient-to-b from-violet-400 via-violet-700 to-violet-700 flex items-center justify-center p-2 rounded-full">
